<?php
/*
Plugin Name: (LamWeb) Gravity Forms
...
class GFForms {
	...
	public static function create_menu() {
		...
		$forms_hook_suffix = add_menu_page( 
			__( 'Forms', 'gravityforms' ), 
			__( 'LW Forms', 'gravityforms' ) . $update_icon, 
			$has_full_access ? 'gform_full_access' : $min_cap, $parent_menu['name'], 
			$parent_menu['callback'], 
			$admin_icon, 
			//apply_filters( 'gform_menu_position', '16.9' ) 
			1002
		); 
